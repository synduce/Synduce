...
;;
;; (define example_tree_1
;;   (list -1 (list 3 (list 3 (list) (list)) (list))
;;         (list -2 (list 1 (list) (list))
;;               (list -4 (list) (list)))))
;; (Main example_tree_1)
;; (bfth example_tree_1)

;; (define example_tree_2
;;   (list -1 (list 3 (list 3 (list) (list))
;;                  (list -2 (list 1 (list) (list)) (list)))
;;         (list -2 (list 1 (list) (list))
;;               (list -4 (list) (list)))))
;; (Main example_tree_2)
;; (bfth example_tree_2)
