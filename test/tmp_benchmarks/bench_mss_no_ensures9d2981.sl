...
(synth-fun odot$3 ((x19 synd_tup_Int_Int_Int_Int) (x20 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x19) (proj_synd_tup_Int_Int_Int_Int_1 x19)
    (proj_synd_tup_Int_Int_Int_Int_2 x19) (proj_synd_tup_Int_Int_Int_Int_3 x19)
    (proj_synd_tup_Int_Int_Int_Int_0 x20) (proj_synd_tup_Int_Int_Int_Int_1 x20)
    (proj_synd_tup_Int_Int_Int_Int_2 x20) (proj_synd_tup_Int_Int_Int_Int_3 x20) 
