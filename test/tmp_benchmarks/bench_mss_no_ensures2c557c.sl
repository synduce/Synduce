...
(synth-fun odot$3 ((x195 synd_tup_Int_Int_Int_Int) (x196 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x195) (proj_synd_tup_Int_Int_Int_Int_1 x195)
    (proj_synd_tup_Int_Int_Int_Int_2 x195) (proj_synd_tup_Int_Int_Int_Int_3 x195)
    (proj_synd_tup_Int_Int_Int_Int_0 x196) (proj_synd_tup_Int_Int_Int_Int_1 x196)
    (proj_synd_tup_Int_Int_Int_Int_2 x196) (proj_synd_tup_Int_Int_Int_Int_3 x196) 
 ...
 (or
  (not
   (and
    ...
    (>= i1075 i1074)))
  (= i1077
   (odot$3 (mk_synd_tup_Int_Int_Int_Int 0 0 0 0)
  ...
  (not
   (and
    (and
     ...
     (>= i1076 0))
    (>= i1075 i1074)))
  (= (max (max i1077 (max (+ i1076 i978) 0)) (max (+ (max (+ i1076 i978) 0) i972) 0))
   (odot$3
  ...
  (not
   (and
    (and
     ...
     (>= i1076 0))
    (>= i1075 i1074)))
  (= (max (max i1077 (max (+ i1076 i1044) 0)) (max (+ (max (+ i1076 i1044) 0) i1009) 0))
   (odot$3
 ...
 (or
  (not
   (and
    ...
    (>= i1075 i1074)))
  (=
   (max (max (max i1077 (max (+ i1076 i1069) 0)) (max (+ (max (+ i1076 i1069) 0) i1044) 0))
