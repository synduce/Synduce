...
(synth-fun odot$1 ((x14 synd_tup_Int_Bool) (x15 synd_tup_Int_Bool)) Bool
 ((IStart Bool) (Ipred Bool) (Ix Int) (Ic Int))
 ((IStart Bool ((and Ipred Ipred)))
  (Ipred Bool
   ((proj_synd_tup_Int_Bool_1 x14) (proj_synd_tup_Int_Bool_1 x15) (not Ipred) 
    (and Ipred Ipred) (or Ipred Ipred) (= Ix Ix) (> Ix Ix) (>= Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Bool_0 x14) (proj_synd_tup_Int_Bool_0 x15) 
