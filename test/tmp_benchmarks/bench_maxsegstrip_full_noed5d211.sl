...
(synth-fun s1$2 ((x83 synd_tup_Int_Int_Int_Int) (x84 synd_tup_Int_Int_Int_Int)) Int
...
(constraint
 (or (not (>= i497 i498))
  (= (max (+ i498 i2) i497)
   (s1$2 (mk_synd_tup_Int_Int_Int_Int i495 i496 i497 i498)
    (mk_synd_tup_Int_Int_Int_Int (max i2 0) (max i2 0) (max i2 0) i2)))))
(constraint
 (or (not (>= i497 i498))
  (= (max (+ (+ i498 i34) i22) (max (+ i498 i34) i497))
   (s1$2 (mk_synd_tup_Int_Int_Int_Int i495 i496 i497 i498)
