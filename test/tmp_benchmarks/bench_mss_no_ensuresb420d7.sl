...
(synth-fun odot$3 ((x37 synd_tup_Int_Int_Int_Int) (x38 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x37) (proj_synd_tup_Int_Int_Int_Int_1 x37)
    (proj_synd_tup_Int_Int_Int_Int_2 x37) (proj_synd_tup_Int_Int_Int_Int_3 x37)
    (proj_synd_tup_Int_Int_Int_Int_0 x38) (proj_synd_tup_Int_Int_Int_Int_1 x38)
