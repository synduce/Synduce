...
(synth-fun odot$3 ((x103 synd_tup_Int_Int_Int_Int) (x104 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x103) (proj_synd_tup_Int_Int_Int_Int_1 x103)
    (proj_synd_tup_Int_Int_Int_Int_2 x103) (proj_synd_tup_Int_Int_Int_Int_3 x103)
    (proj_synd_tup_Int_Int_Int_Int_0 x104) (proj_synd_tup_Int_Int_Int_Int_1 x104)
    (proj_synd_tup_Int_Int_Int_Int_2 x104) (proj_synd_tup_Int_Int_Int_Int_3 x104) 
 ...
 (or
  (not
   (and
    ...
    (>= i866 (- i867))))
  (= i868
   (odot$3 (mk_synd_tup_Int_Int_Int_Int 0 0 0 0) (mk_synd_tup_Int_Int_Int_Int i865 i866 i867 i868)))))
(constraint
 (or
  (not
   (and
