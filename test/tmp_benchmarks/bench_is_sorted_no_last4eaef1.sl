...
(synth-fun odot$0 ((x100 synd_tup_Int_Bool_Int) (x101 synd_tup_Int_Bool_Int)) Int
 ((Ix Int) (Ic Int) (Ipred Bool))
 ((Ix Int
   (Ic (proj_synd_tup_Int_Bool_Int_0 x100) (proj_synd_tup_Int_Bool_Int_2 x100)
    (proj_synd_tup_Int_Bool_Int_0 x101) (proj_synd_tup_Int_Bool_Int_2 x101) 
    (- Ix) (+ Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
  (Ipred Bool
   ((proj_synd_tup_Int_Bool_Int_1 x100) (proj_synd_tup_Int_Bool_Int_1 x101) 
