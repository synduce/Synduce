...
(synth-fun join$1 ((x116 Int) (x117 synd_tup_Int_Int) (x118 synd_tup_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((ite Ipred Ix Ix)))
  (Ix Int
   (Ic x116 (proj_synd_tup_Int_Int_0 x117) (proj_synd_tup_Int_Int_1 x117)
    (proj_synd_tup_Int_Int_0 x118) (proj_synd_tup_Int_Int_1 x118) (- Ix) 
...
(constraint
 (or (not (and (< i4 i) (and (<= i i2) (and true true))))
  (= (ite (> (+ (+ (ite (= i4 i2) 1 0) (ite (= i4 i2) 1 0)) 1) 2) i2 i4)
   (join$1 i
