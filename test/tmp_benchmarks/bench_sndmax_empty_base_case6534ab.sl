...
(synth-fun odot$1 ((x54 synd_tup_Int_Int) (x55 synd_tup_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_0 x54) (proj_synd_tup_Int_Int_1 x54) (proj_synd_tup_Int_Int_0 x55)
    (proj_synd_tup_Int_Int_1 x55) (- Ix) (+ Ix Ix) (min Ix Ix) (max Ix Ix) 
    (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
...
(constraint
 (or
  ...
  (= i1222 (odot$1 (mk_synd_tup_Int_Int 0 0) (mk_synd_tup_Int_Int i1221 i1222)))))
(constraint
 (or
  (not
   (and (>= i1221 i1222)
    (and
     ...
     (and (= i0 i0) (>= i1222 0)))))
  (= (max i1222 (min i0 i1221))
   (odot$1 (mk_synd_tup_Int_Int (max i0 0) (max 0 (min i0 0))) (mk_synd_tup_Int_Int i1221 i1222)))))
(constraint
 (or
  (not
   (and (>= i1221 i1222)
...
(constraint
 (or
  ...
  (= (max (max i1222 (min i251 i1221)) (min i241 (max i251 i1221)))
   (odot$1
