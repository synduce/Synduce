...
(synth-fun odot$1 ((x25 synd_tup_Int_Int_Bool) (x26 synd_tup_Int_Int_Bool)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((min Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Bool_0 x25) (proj_synd_tup_Int_Int_Bool_1 x25)
    (proj_synd_tup_Int_Int_Bool_0 x26) (proj_synd_tup_Int_Int_Bool_1 x26) 
    (- Ix) (+ Ix Ix) (min Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
  (Ipred Bool
   ((proj_synd_tup_Int_Int_Bool_2 x25) (proj_synd_tup_Int_Int_Bool_2 x26) 
...
(constraint
 (or (not (and (<= i10 i9) (and (<= i10 0) (= b9 (>= i10 0)))))
  (= i10 (odot$1 (mk_synd_tup_Int_Int_Bool 0 0 true) (mk_synd_tup_Int_Int_Bool i9 i10 b9)))))
(constraint
 (or (not (and (<= i10 i9) (and (<= i10 0) (= b9 (>= i10 0)))))
  (= (min i10 (ite b0 (+ i9 1) (- i9 1)))
   (odot$1
...
(constraint
 (or (not (and (<= i10 i9) (and (<= i10 0) (= b9 (>= i10 0)))))
  (=
   (min (min i10 (ite b7 (+ i9 1) (- i9 1)))
    (ite b4 (+ (ite b7 (+ i9 1) (- i9 1)) 1) (- (ite b7 (+ i9 1) (- i9 1)) 1)))
   (odot$1
