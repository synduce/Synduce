...
(synth-fun odot$3 ((x83 synd_tup_Int_Int_Int_Int) (x84 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x83) (proj_synd_tup_Int_Int_Int_Int_1 x83)
    (proj_synd_tup_Int_Int_Int_Int_2 x83) (proj_synd_tup_Int_Int_Int_Int_3 x83)
    (proj_synd_tup_Int_Int_Int_Int_0 x84) (proj_synd_tup_Int_Int_Int_Int_1 x84)
    (proj_synd_tup_Int_Int_Int_Int_2 x84) (proj_synd_tup_Int_Int_Int_Int_3 x84) 
