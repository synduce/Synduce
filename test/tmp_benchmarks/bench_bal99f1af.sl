...
(synth-fun odot$1 ((x7 synd_tup_Int_Int_Bool) (x8 synd_tup_Int_Int_Bool)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((min Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Bool_0 x7) (proj_synd_tup_Int_Int_Bool_1 x7)
    (proj_synd_tup_Int_Int_Bool_0 x8) (proj_synd_tup_Int_Int_Bool_1 x8) 
    (- Ix) (+ Ix Ix) (min Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
  (Ipred Bool
   ((proj_synd_tup_Int_Int_Bool_2 x7) (proj_synd_tup_Int_Int_Bool_2 x8) 
