...
(synth-fun f2$0 ((x20 synd_tup_Int_Bool) (x21 synd_tup_Int_Bool)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((ite Ipred Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Bool_0 x20) (proj_synd_tup_Int_Bool_0 x21) 
    (- Ix) (+ Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
  (Ipred Bool
   ((proj_synd_tup_Int_Bool_1 x20) (proj_synd_tup_Int_Bool_1 x21) (= Ix Ix) 
