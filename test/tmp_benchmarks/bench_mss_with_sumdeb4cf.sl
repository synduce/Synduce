...
(synth-fun oplus$0 ((x15 Int) (x16 Int) (x17 synd_tup_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic x15 x16 (proj_synd_tup_Int_Int_Int_0 x17) (proj_synd_tup_Int_Int_Int_1 x17)
    (proj_synd_tup_Int_Int_Int_2 x17) (- Ix) (+ Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
