...
(synth-fun oplus$0 ((x103 Int) (x104 synd_tup_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic x103 (proj_synd_tup_Int_Int_Int_0 x104) (proj_synd_tup_Int_Int_Int_1 x104)
    (proj_synd_tup_Int_Int_Int_2 x104) (- Ix) (+ Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
