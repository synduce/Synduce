...
(synth-fun oplus$1 ((x30 Int) (x31 synd_tup_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic x30 (proj_synd_tup_Int_Int_Int_0 x31) (proj_synd_tup_Int_Int_Int_1 x31)
    (proj_synd_tup_Int_Int_Int_2 x31) (- Ix) (+ Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
