...
(synth-fun odot$1 ((x12 synd_tup_Int_Int_Int_Int) (x13 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x12) (proj_synd_tup_Int_Int_Int_Int_1 x12)
    (proj_synd_tup_Int_Int_Int_Int_2 x12) (proj_synd_tup_Int_Int_Int_Int_3 x12)
    (proj_synd_tup_Int_Int_Int_Int_0 x13) (proj_synd_tup_Int_Int_Int_Int_1 x13)
    (proj_synd_tup_Int_Int_Int_Int_2 x13) (proj_synd_tup_Int_Int_Int_Int_3 x13) 
