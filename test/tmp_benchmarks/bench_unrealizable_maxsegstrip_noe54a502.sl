...
(synth-fun s1$1 ((x61 synd_tup_Int_Int_Int_Int) (x62 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x61) (proj_synd_tup_Int_Int_Int_Int_1 x61)
    (proj_synd_tup_Int_Int_Int_Int_2 x61) (proj_synd_tup_Int_Int_Int_Int_3 x61)
    (proj_synd_tup_Int_Int_Int_Int_0 x62) (proj_synd_tup_Int_Int_Int_Int_1 x62)
