...
(synth-fun odot$3 ((x69 synd_tup_Int_Int_Int_Int) (x70 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x69) (proj_synd_tup_Int_Int_Int_Int_1 x69)
    (proj_synd_tup_Int_Int_Int_Int_2 x69) (proj_synd_tup_Int_Int_Int_Int_3 x69)
    (proj_synd_tup_Int_Int_Int_Int_0 x70) (proj_synd_tup_Int_Int_Int_Int_1 x70)
    (proj_synd_tup_Int_Int_Int_Int_2 x70) (proj_synd_tup_Int_Int_Int_Int_3 x70) 
