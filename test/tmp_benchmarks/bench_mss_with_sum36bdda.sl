...
(synth-fun oplus$0 ((x39 Int) (x40 Int) (x41 synd_tup_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic x39 x40 (proj_synd_tup_Int_Int_Int_0 x41) (proj_synd_tup_Int_Int_Int_1 x41)
    (proj_synd_tup_Int_Int_Int_2 x41) (- Ix) (+ Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
