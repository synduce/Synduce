...
(synth-fun f1$0 ((x14 synd_tup_Int_Bool)) Int ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((ite Ipred Ix Ix)))
  (Ix Int (Ic (proj_synd_tup_Int_Bool_0 x14) (- Ix) (+ Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
  (Ipred Bool
   ((proj_synd_tup_Int_Bool_1 x14) (= Ix Ix) (> Ix Ix) (not Ipred) (and Ipred Ipred)
    (or Ipred Ipred)))))
(declare-var b2 Bool)
