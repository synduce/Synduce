...
(synth-fun joinl$0 ((x39 Int) (x40 synd_tup_Int_Int) (x41 synd_tup_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((+ Ix Ix)))
  (Ix Int
   (Ic x39 (proj_synd_tup_Int_Int_0 x40) (proj_synd_tup_Int_Int_1 x40)
    (proj_synd_tup_Int_Int_0 x41) (proj_synd_tup_Int_Int_1 x41) (- Ix) 
