...
(synth-fun odot ((x6 synd_tup_Int_Int_Bool) (x7 synd_tup_Int_Int_Bool)) synd_tup_Int_Int_Bool
 ((Tr synd_tup_Int_Int_Bool) (Ix Int) (Ic Int) (Ipred Bool))
 ((Tr synd_tup_Int_Int_Bool ((mk_synd_tup_Int_Int_Bool Ix Ix Ipred)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Bool_0 x6) (proj_synd_tup_Int_Int_Bool_1 x6)
    (proj_synd_tup_Int_Int_Bool_0 x7) (proj_synd_tup_Int_Int_Bool_1 x7) 
    (- Ix) (+ Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
  (Ipred Bool
   ((proj_synd_tup_Int_Int_Bool_2 x6) (proj_synd_tup_Int_Int_Bool_2 x7) 
