...
(synth-fun f1$1 ((x74 synd_tup_Int_Bool)) Bool ((IStart Bool) (Ipred Bool) (Ix Int) (Ic Int))
 ((IStart Bool ((and Ipred Ipred)))
  (Ipred Bool
   ((proj_synd_tup_Int_Bool_1 x74) (not Ipred) (and Ipred Ipred) (or Ipred Ipred) 
    (= Ix Ix) (> Ix Ix) (>= Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Bool_0 x74) (- Ix) (+ Ix Ix) (min Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))))
   ...
   (and
    (and (and (>= i3068 0) (= b9 (= i3068 0)))
     (and
      ...
      (or (not (<= i 0)) (> i3068 i))))
    (<= i 0)))
  (= (and b9 (>= i4 0)) (f1$1 (mk_synd_tup_Int_Bool i3068 b9)))))
(constraint
 (or
  (not
   (and
    (and (and (>= i3068 0) (= b9 (= i3068 0)))
     (and
      ...
      (or (not (<= i 0)) (> i3068 i))))
    (<= i 0)))
  (= (and b9 (>= (+ i3 i1005) 0)) (f1$1 (mk_synd_tup_Int_Bool i3068 b9)))))
(check-synth)
