...
(synth-fun odot$1 ((x2 synd_tup_Bool_Bool) (x3 synd_tup_Bool_Bool)) Bool
 ((IStart Bool) (Ipred Bool))
 ((IStart Bool ((or Ipred Ipred)))
  (Ipred Bool
   ((proj_synd_tup_Bool_Bool_0 x2) (proj_synd_tup_Bool_Bool_1 x2) (proj_synd_tup_Bool_Bool_0 x3)
    (proj_synd_tup_Bool_Bool_1 x3) (not Ipred) (and Ipred Ipred) (or Ipred Ipred)))))
(declare-var b1 Bool)
(declare-var b3 Bool)
(declare-var b2 Bool)
