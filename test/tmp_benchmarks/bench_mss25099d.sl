...
(synth-fun odot$2 ((x50 synd_tup_Int_Int_Int_Int) (x51 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x50) (proj_synd_tup_Int_Int_Int_Int_1 x50)
    (proj_synd_tup_Int_Int_Int_Int_2 x50) (proj_synd_tup_Int_Int_Int_Int_3 x50)
    (proj_synd_tup_Int_Int_Int_Int_0 x51) (proj_synd_tup_Int_Int_Int_Int_1 x51)
