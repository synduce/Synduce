...
(synth-fun f2$0 ((x128 synd_tup_Int_Bool) (x129 synd_tup_Int_Bool)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((ite Ipred Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Bool_0 x128) (proj_synd_tup_Int_Bool_0 x129) 
    (- Ix) (+ Ix Ix) (min Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
  (Ipred Bool
   ((proj_synd_tup_Int_Bool_1 x128) (proj_synd_tup_Int_Bool_1 x129) (= Ix Ix) 
