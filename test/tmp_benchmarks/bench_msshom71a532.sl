...
(synth-fun odot$3 ((x28 synd_tup_Int_Int_Int_Int) (x29 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x28) (proj_synd_tup_Int_Int_Int_Int_1 x28)
    (proj_synd_tup_Int_Int_Int_Int_2 x28) (proj_synd_tup_Int_Int_Int_Int_3 x28)
    (proj_synd_tup_Int_Int_Int_Int_0 x29) (proj_synd_tup_Int_Int_Int_Int_1 x29)
    (proj_synd_tup_Int_Int_Int_Int_2 x29) (proj_synd_tup_Int_Int_Int_Int_3 x29) 
