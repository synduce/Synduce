...
(synth-fun joinl$1 ((x33 Int) (x34 synd_tup_Int_Int) (x35 synd_tup_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic x33 (proj_synd_tup_Int_Int_0 x34) (proj_synd_tup_Int_Int_1 x34)
    (proj_synd_tup_Int_Int_0 x35) (proj_synd_tup_Int_Int_1 x35) (- Ix) 
