...
(synth-fun oplus$1 ((x97 Int) (x98 synd_tup_Int_Int_Int)) Int ((IStart Int) (Ix Int) (Ic Int))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic x97 (proj_synd_tup_Int_Int_Int_0 x98) (proj_synd_tup_Int_Int_Int_1 x98)
    (proj_synd_tup_Int_Int_Int_2 x98) (- Ix) (+ Ix Ix) (max Ix Ix)))
  (Ic Int ((Constant Int)))))
(declare-var i Int)
(declare-var p1 Int)
(declare-var p Int)
