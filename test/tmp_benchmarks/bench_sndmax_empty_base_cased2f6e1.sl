...
(synth-fun odot$0 ((x58 synd_tup_Int_Int) (x59 synd_tup_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_0 x58) (proj_synd_tup_Int_Int_1 x58) (proj_synd_tup_Int_Int_0 x59)
    (proj_synd_tup_Int_Int_1 x59) (- Ix) (+ Ix Ix) (min Ix Ix) (max Ix Ix) 
    (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
