...
(synth-fun odot$3 ((x71 synd_tup_Int_Int_Int_Int) (x72 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x71) (proj_synd_tup_Int_Int_Int_Int_1 x71)
    (proj_synd_tup_Int_Int_Int_Int_2 x71) (proj_synd_tup_Int_Int_Int_Int_3 x71)
    (proj_synd_tup_Int_Int_Int_Int_0 x72) (proj_synd_tup_Int_Int_Int_Int_1 x72)
    (proj_synd_tup_Int_Int_Int_Int_2 x72) (proj_synd_tup_Int_Int_Int_Int_3 x72) 
