...
(synth-fun odot$1 ((x62 synd_tup_Int_Int_Int_Int) (x63 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x62) (proj_synd_tup_Int_Int_Int_Int_1 x62)
    (proj_synd_tup_Int_Int_Int_Int_2 x62) (proj_synd_tup_Int_Int_Int_Int_3 x62)
    (proj_synd_tup_Int_Int_Int_Int_0 x63) (proj_synd_tup_Int_Int_Int_Int_1 x63)
