...
(synth-fun oplus$2 ((x26 Int) (x27 synd_tup_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic x26 (proj_synd_tup_Int_Int_Int_0 x27) (proj_synd_tup_Int_Int_Int_1 x27)
    (proj_synd_tup_Int_Int_Int_2 x27) (- Ix) (+ Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
