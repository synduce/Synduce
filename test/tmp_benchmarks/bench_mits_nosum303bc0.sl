...
(synth-fun join1$0 ((x174 Int) (x175 synd_tup_Int_Int) (x176 synd_tup_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic x174 (proj_synd_tup_Int_Int_0 x175) (proj_synd_tup_Int_Int_1 x175)
    (proj_synd_tup_Int_Int_0 x176) (proj_synd_tup_Int_Int_1 x176) (- Ix) 
