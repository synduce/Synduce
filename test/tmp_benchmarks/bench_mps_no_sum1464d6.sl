...
(synth-fun s0$1 () Int)
(synth-fun join$0 ((x31 synd_tup_Int_Int) (x32 synd_tup_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_0 x31) (proj_synd_tup_Int_Int_1 x31) (proj_synd_tup_Int_Int_0 x32)
    (proj_synd_tup_Int_Int_1 x32) (- Ix) (+ Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
...
(constraint
 (or (not (>= _elim_i 0))
  (= _elim_i (join$0 (mk_synd_tup_Int_Int 0 s0$1) (mk_synd_tup_Int_Int _elim_i _elim_i0)))))
(constraint
 (or (not (>= _elim_i 0))
  (= (max (+ _elim_i i) 0)
