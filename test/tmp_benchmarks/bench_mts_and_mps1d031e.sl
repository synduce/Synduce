...
(synth-fun oplus$2 ((x14 Int) (x15 synd_tup_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic x14 (proj_synd_tup_Int_Int_Int_0 x15) (proj_synd_tup_Int_Int_Int_1 x15)
    (proj_synd_tup_Int_Int_Int_2 x15) (- Ix) (+ Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
