...
(synth-fun odot$0 ((x29 synd_tup_Int_Int_Bool) (x30 synd_tup_Int_Int_Bool)) Int
 ((Ix Int) (Ic Int) (Ipred Bool))
 ((Ix Int
   (Ic (proj_synd_tup_Int_Int_Bool_0 x29) (proj_synd_tup_Int_Int_Bool_1 x29)
    (proj_synd_tup_Int_Int_Bool_0 x30) (proj_synd_tup_Int_Int_Bool_1 x30) 
    (- Ix) (+ Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
  (Ipred Bool
   ((proj_synd_tup_Int_Int_Bool_2 x29) (proj_synd_tup_Int_Int_Bool_2 x30) 
