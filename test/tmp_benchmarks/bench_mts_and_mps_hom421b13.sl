...
(synth-fun odot$1 ((x7 synd_tup_Int_Int_Int) (x8 synd_tup_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_0 x7) (proj_synd_tup_Int_Int_Int_1 x7)
    (proj_synd_tup_Int_Int_Int_2 x7) (proj_synd_tup_Int_Int_Int_0 x8)
    (proj_synd_tup_Int_Int_Int_1 x8) (proj_synd_tup_Int_Int_Int_2 x8) 
