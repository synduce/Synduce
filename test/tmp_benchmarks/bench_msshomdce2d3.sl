...
(synth-fun odot$2 ((x10 synd_tup_Int_Int_Int_Int) (x11 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x10) (proj_synd_tup_Int_Int_Int_Int_1 x10)
    (proj_synd_tup_Int_Int_Int_Int_2 x10) (proj_synd_tup_Int_Int_Int_Int_3 x10)
    (proj_synd_tup_Int_Int_Int_Int_0 x11) (proj_synd_tup_Int_Int_Int_Int_1 x11)
    (proj_synd_tup_Int_Int_Int_Int_2 x11) (proj_synd_tup_Int_Int_Int_Int_3 x11) 
