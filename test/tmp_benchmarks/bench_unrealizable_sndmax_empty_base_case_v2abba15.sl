...
(synth-fun odot$1 ((x66 synd_tup_Int_Int) (x67 synd_tup_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_0 x66) (proj_synd_tup_Int_Int_1 x66) (proj_synd_tup_Int_Int_0 x67)
    (proj_synd_tup_Int_Int_1 x67) (- Ix) (+ Ix Ix) (min Ix Ix) (max Ix Ix) 
    (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
