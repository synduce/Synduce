...
(synth-fun f1$0 ((x51 Int) (x52 Int) (x53 synd_tup_Bool_Int_Int)) Bool
 ((Ipred Bool) (Ix Int) (Ic Int))
 ((Ipred Bool
   ((proj_synd_tup_Bool_Int_Int_0 x53) (not Ipred) (and Ipred Ipred) 
    (or Ipred Ipred) (= Ix Ix) (> Ix Ix) (>= Ix Ix)))
  (Ix Int
   (Ic x51 x52 (proj_synd_tup_Bool_Int_Int_1 x53) (proj_synd_tup_Bool_Int_Int_2 x53) 
