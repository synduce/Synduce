...
(synth-fun s1$0 ((x20 synd_tup_Int_Int) (x21 synd_tup_Int_Int)) Int
...
(declare-var i2 Int)
(constraint
 (= (max (+ i24 i2) i23) (s1$0 (mk_synd_tup_Int_Int i23 i24) (mk_synd_tup_Int_Int (max 0 i2) i2))))
(constraint
 (= (max (+ (+ i24 i20) i10) (max (+ i24 i20) i23))
