...
(synth-fun odot$1 ((x27 synd_tup_Int_Int_Int) (x28 synd_tup_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_0 x27) (proj_synd_tup_Int_Int_Int_1 x27)
    (proj_synd_tup_Int_Int_Int_2 x27) (proj_synd_tup_Int_Int_Int_0 x28)
    (proj_synd_tup_Int_Int_Int_1 x28) (proj_synd_tup_Int_Int_Int_2 x28) 
