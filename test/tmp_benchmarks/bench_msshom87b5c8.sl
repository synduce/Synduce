...
(synth-fun odot$2 ((x32 synd_tup_Int_Int_Int_Int) (x33 synd_tup_Int_Int_Int_Int)) Int
...
(constraint
 (or
  ...
  (= i24
   (odot$2 (mk_synd_tup_Int_Int_Int_Int 0 0 0 0) (mk_synd_tup_Int_Int_Int_Int i22 i23 i24 i25)))))
(constraint
 (or
  (not
   (and (>= i23 0)
