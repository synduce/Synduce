...
(synth-fun odot$2 ((x89 synd_tup_Int_Int_Int_Int) (x90 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x89) (proj_synd_tup_Int_Int_Int_Int_1 x89)
    (proj_synd_tup_Int_Int_Int_Int_2 x89) (proj_synd_tup_Int_Int_Int_Int_3 x89)
    (proj_synd_tup_Int_Int_Int_Int_0 x90) (proj_synd_tup_Int_Int_Int_Int_1 x90)
    (proj_synd_tup_Int_Int_Int_Int_2 x90) (proj_synd_tup_Int_Int_Int_Int_3 x90) 
