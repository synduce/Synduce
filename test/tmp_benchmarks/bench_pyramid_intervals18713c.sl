...
(synth-fun s1$2 ((x48 synd_tup_Int_Int) (x49 synd_tup_Int_Int_Bool)) Bool
 ((IStart Bool) (Ipred Bool) (Ix Int) (Ic Int))
 ((IStart Bool ((and Ipred Ipred)))
  (Ipred Bool
   ((proj_synd_tup_Int_Int_Bool_2 x49) (not Ipred) (and Ipred Ipred) 
    (or Ipred Ipred) (= Ix Ix) (> Ix Ix) (>= Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_0 x48) (proj_synd_tup_Int_Int_1 x48)
    (proj_synd_tup_Int_Int_Bool_0 x49) (proj_synd_tup_Int_Int_Bool_1 x49) 
