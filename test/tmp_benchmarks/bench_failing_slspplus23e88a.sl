...
(synth-fun f1$1 ((x119 synd_tup_Int_Bool)) Bool ((IStart Bool) (Ipred Bool) (Ix Int) (Ic Int))
 ((IStart Bool ((and Ipred Ipred)))
  (Ipred Bool
   ((proj_synd_tup_Int_Bool_1 x119) (not Ipred) (and Ipred Ipred) (or Ipred Ipred) 
    (= Ix Ix) (> Ix Ix) (>= Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Bool_0 x119) (- Ix) (+ Ix Ix) (min Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))))
   ...
   (and
    (and (and (>= i5613 0) (= b15 (= i5613 0)))
     (and
      ...
      (or (not (<= i 0)) (> i5613 i))))
    (<= i 0)))
  (= (and b15 (>= i4 0)) (f1$1 (mk_synd_tup_Int_Bool i5613 b15)))))
(constraint
 (or
  (not
   (and
    (and (and (>= i5613 0) (= b15 (= i5613 0)))
     (and
      ...
      (or (not (<= i 0)) (> i5613 i))))
    (<= i 0)))
  (= (and b15 (>= (+ i3 i1005) 0)) (f1$1 (mk_synd_tup_Int_Bool i5613 b15)))))
(constraint
 (or
  (not
   (and
    (and (and (>= i5613 0) (= b15 (= i5613 0)))
     (and
      ...
      (or (not (<= i 0)) (> i5613 i))))
    (<= i 0)))
  (= (and b15 (>= (+ i3 (+ i1004 i3078)) 0)) (f1$1 (mk_synd_tup_Int_Bool i5613 b15)))))
(check-synth)
