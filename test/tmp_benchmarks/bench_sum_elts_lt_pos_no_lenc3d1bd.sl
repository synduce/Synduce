...
(synth-fun f$0 ((x56 Int) (x57 synd_tup_Int_Int)) Int ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
...
(synth-fun f$1 ((x58 Int) (x59 synd_tup_Int_Int)) Int ((Ix Int) (Ic Int) (Ipred Bool))
 ((Ix Int
 ...
 (=
  ...
  (f$0 i0
   (mk_synd_tup_Int_Int
    ...
    (f$1 i1
     (mk_synd_tup_Int_Int (f$0 i2 (mk_synd_tup_Int_Int 0 1)) (f$1 i2 (mk_synd_tup_Int_Int 0 1))))))))
(check-synth)
