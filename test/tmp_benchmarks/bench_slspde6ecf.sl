...
(synth-fun f2$0 ((x22 Int) (x23 synd_tup_Int_Bool) (x24 synd_tup_Int_Bool)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((ite Ipred Ix Ix)))
  (Ix Int
   (Ic x22 (proj_synd_tup_Int_Bool_0 x23) (proj_synd_tup_Int_Bool_0 x24) 
    (- Ix) (+ Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
  (Ipred Bool
   ((proj_synd_tup_Int_Bool_1 x23) (proj_synd_tup_Int_Bool_1 x24) (= Ix Ix) 
