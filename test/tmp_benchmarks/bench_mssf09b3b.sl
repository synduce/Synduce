...
(synth-fun odot$1 ((x54 synd_tup_Int_Int_Int_Int) (x55 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x54) (proj_synd_tup_Int_Int_Int_Int_1 x54)
    (proj_synd_tup_Int_Int_Int_Int_2 x54) (proj_synd_tup_Int_Int_Int_Int_3 x54)
    (proj_synd_tup_Int_Int_Int_Int_0 x55) (proj_synd_tup_Int_Int_Int_Int_1 x55)
