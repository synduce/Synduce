...
(synth-fun odot$3 ((x39 synd_tup_Int_Int_Int_Int) (x40 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x39) (proj_synd_tup_Int_Int_Int_Int_1 x39)
    (proj_synd_tup_Int_Int_Int_Int_2 x39) (proj_synd_tup_Int_Int_Int_Int_3 x39)
    (proj_synd_tup_Int_Int_Int_Int_0 x40) (proj_synd_tup_Int_Int_Int_Int_1 x40)
    (proj_synd_tup_Int_Int_Int_Int_2 x40) (proj_synd_tup_Int_Int_Int_Int_3 x40) 
