...
(synth-fun oplus$1 ((x33 Int) (x34 Int) (x35 synd_tup_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic x33 x34 (proj_synd_tup_Int_Int_Int_0 x35) (proj_synd_tup_Int_Int_Int_1 x35)
    (proj_synd_tup_Int_Int_Int_2 x35) (- Ix) (+ Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
