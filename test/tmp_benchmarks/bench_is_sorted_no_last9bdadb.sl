...
(synth-fun odot$1 ((x98 synd_tup_Int_Bool_Int) (x99 synd_tup_Int_Bool_Int)) Bool
 ((IStart Bool) (Ipred Bool) (Ix Int) (Ic Int))
 ((IStart Bool ((and Ipred Ipred)))
  (Ipred Bool
   ((proj_synd_tup_Int_Bool_Int_1 x98) (proj_synd_tup_Int_Bool_Int_1 x99) 
    (not Ipred) (and Ipred Ipred) (or Ipred Ipred) (= Ix Ix) (> Ix Ix) 
    (>= Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Bool_Int_0 x98) (proj_synd_tup_Int_Bool_Int_2 x98)
    (proj_synd_tup_Int_Bool_Int_0 x99) (proj_synd_tup_Int_Bool_Int_2 x99) 
