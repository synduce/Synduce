...
(synth-fun odot$3 ((x21 synd_tup_Int_Int_Int_Int) (x22 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x21) (proj_synd_tup_Int_Int_Int_Int_1 x21)
    (proj_synd_tup_Int_Int_Int_Int_2 x21) (proj_synd_tup_Int_Int_Int_Int_3 x21)
    (proj_synd_tup_Int_Int_Int_Int_0 x22) (proj_synd_tup_Int_Int_Int_Int_1 x22)
    (proj_synd_tup_Int_Int_Int_Int_2 x22) (proj_synd_tup_Int_Int_Int_Int_3 x22) 
