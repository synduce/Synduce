...
(synth-fun odot$1 ((x27 synd_tup_Int_Int_Bool) (x28 synd_tup_Int_Int_Bool)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((min Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Bool_0 x27) (proj_synd_tup_Int_Int_Bool_1 x27)
    (proj_synd_tup_Int_Int_Bool_0 x28) (proj_synd_tup_Int_Int_Bool_1 x28) 
    (- Ix) (+ Ix Ix) (min Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
  (Ipred Bool
   ((proj_synd_tup_Int_Int_Bool_2 x27) (proj_synd_tup_Int_Int_Bool_2 x28) 
