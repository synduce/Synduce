...
(synth-fun odot$3 ((x46 synd_tup_Int_Int_Int_Int) (x47 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x46) (proj_synd_tup_Int_Int_Int_Int_1 x46)
    (proj_synd_tup_Int_Int_Int_Int_2 x46) (proj_synd_tup_Int_Int_Int_Int_3 x46)
    (proj_synd_tup_Int_Int_Int_Int_0 x47) (proj_synd_tup_Int_Int_Int_Int_1 x47)
    (proj_synd_tup_Int_Int_Int_Int_2 x47) (proj_synd_tup_Int_Int_Int_Int_3 x47) 
