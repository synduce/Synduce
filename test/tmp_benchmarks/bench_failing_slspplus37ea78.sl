...
(synth-fun f2$0 ((x126 synd_tup_Int_Bool) (x127 synd_tup_Int_Bool)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((ite Ipred Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Bool_0 x126) (proj_synd_tup_Int_Bool_0 x127) 
    (- Ix) (+ Ix Ix) (min Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
  (Ipred Bool
   ((proj_synd_tup_Int_Bool_1 x126) (proj_synd_tup_Int_Bool_1 x127) (= Ix Ix) 
   ...
   (and
    (and (and (>= i5613 0) (= b15 (= i5613 0)))
     (and
      ...
      (or (not (<= i 0)) (> i5613 i))))
    (not (<= i 0))))
  (= (ite (and (>= i4 0) b15) (+ i5613 i4) 0)
   (f2$0 (mk_synd_tup_Int_Bool i5613 b15) (mk_synd_tup_Int_Bool (max 0 i4) (>= i4 0))))))
(constraint
 (or
  (not
   (and
  ...
  (= (ite (and (>= (+ i3 i1005) 0) b15) (+ i5613 (+ i3 i1005)) 0)
   (f2$0 (mk_synd_tup_Int_Bool i5613 b15)
...
(constraint
 (or
  ...
  (= (ite (and (>= (+ i3 (+ i1004 i3078)) 0) b15) (+ i5613 (+ i3 (+ i1004 i3078))) 0)
   (f2$0 (mk_synd_tup_Int_Bool i5613 b15)
    (mk_synd_tup_Int_Bool (max 0 (+ i3 (+ i1004 i3078))) (>= (+ i3 (+ i1004 i3078)) 0))))))
(check-synth)
