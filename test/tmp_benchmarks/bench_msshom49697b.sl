...
(synth-fun odot$3 ((x6 synd_tup_Int_Int_Int_Int) (x7 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x6) (proj_synd_tup_Int_Int_Int_Int_1 x6)
    (proj_synd_tup_Int_Int_Int_Int_2 x6) (proj_synd_tup_Int_Int_Int_Int_3 x6)
    (proj_synd_tup_Int_Int_Int_Int_0 x7) (proj_synd_tup_Int_Int_Int_Int_1 x7)
    (proj_synd_tup_Int_Int_Int_Int_2 x7) (proj_synd_tup_Int_Int_Int_Int_3 x7) 
