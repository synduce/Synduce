...
(synth-fun s1$2 ((x65 synd_tup_Int_Int_Int_Int) (x66 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x65) (proj_synd_tup_Int_Int_Int_Int_1 x65)
    (proj_synd_tup_Int_Int_Int_Int_2 x65) (proj_synd_tup_Int_Int_Int_Int_3 x65)
    (proj_synd_tup_Int_Int_Int_Int_0 x66) (proj_synd_tup_Int_Int_Int_Int_1 x66)
    (proj_synd_tup_Int_Int_Int_Int_2 x66) (proj_synd_tup_Int_Int_Int_Int_3 x66) 
