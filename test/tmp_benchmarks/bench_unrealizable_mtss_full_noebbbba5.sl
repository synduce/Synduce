...
(synth-fun s1$0 ((x63 synd_tup_Int_Int) (x64 synd_tup_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_0 x63) (proj_synd_tup_Int_Int_1 x63) (proj_synd_tup_Int_Int_0 x64)
    (proj_synd_tup_Int_Int_1 x64) (- Ix) (+ Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
