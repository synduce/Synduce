...
(synth-fun odot$2 ((x23 synd_tup_Int_Int_Int) (x24 synd_tup_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_0 x23) (proj_synd_tup_Int_Int_Int_1 x23)
    (proj_synd_tup_Int_Int_Int_2 x23) (proj_synd_tup_Int_Int_Int_0 x24)
    (proj_synd_tup_Int_Int_Int_1 x24) (proj_synd_tup_Int_Int_Int_2 x24) 
