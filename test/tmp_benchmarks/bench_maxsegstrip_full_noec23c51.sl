...
(synth-fun s1$0 ((x193 synd_tup_Int_Int_Int_Int) (x194 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x193) (proj_synd_tup_Int_Int_Int_Int_1 x193)
    (proj_synd_tup_Int_Int_Int_Int_2 x193) (proj_synd_tup_Int_Int_Int_Int_3 x193)
    (proj_synd_tup_Int_Int_Int_Int_0 x194) (proj_synd_tup_Int_Int_Int_Int_1 x194)
    (proj_synd_tup_Int_Int_Int_Int_2 x194) (proj_synd_tup_Int_Int_Int_Int_3 x194) 
 ...
 (or
  (not
   (and (and (and (and (>= i5429 i5430) (>= i5428 i5429)) (>= i5428 i5427)) (>= i5427 i5430))
    (>= i5427 0)))
  (= (max (+ i5427 i2) 0)
   (s1$0 (mk_synd_tup_Int_Int_Int_Int i5427 i5428 i5429 i5430)
