...
(synth-fun f2$0 ((x83 synd_tup_Int_Bool) (x84 synd_tup_Int_Bool)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((ite Ipred Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Bool_0 x83) (proj_synd_tup_Int_Bool_0 x84) 
    (- Ix) (+ Ix Ix) (min Ix Ix) (max Ix Ix) (ite Ipred Ix Ix)))
  (Ic Int ((Constant Int)))
  (Ipred Bool
   ((proj_synd_tup_Int_Bool_1 x83) (proj_synd_tup_Int_Bool_1 x84) (= Ix Ix) 
