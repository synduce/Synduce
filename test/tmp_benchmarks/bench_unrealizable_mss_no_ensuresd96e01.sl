...
(synth-fun odot$2 ((x91 synd_tup_Int_Int_Int_Int) (x92 synd_tup_Int_Int_Int_Int)) Int
 ((IStart Int) (Ix Int) (Ic Int) (Ipred Bool))
 ((IStart Int ((max Ix Ix)))
  (Ix Int
   (Ic (proj_synd_tup_Int_Int_Int_Int_0 x91) (proj_synd_tup_Int_Int_Int_Int_1 x91)
    (proj_synd_tup_Int_Int_Int_Int_2 x91) (proj_synd_tup_Int_Int_Int_Int_3 x91)
    (proj_synd_tup_Int_Int_Int_Int_0 x92) (proj_synd_tup_Int_Int_Int_Int_1 x92)
    (proj_synd_tup_Int_Int_Int_Int_2 x92) (proj_synd_tup_Int_Int_Int_Int_3 x92) 
