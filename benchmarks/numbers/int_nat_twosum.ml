...
let rec two_isum = function
  | TwoInats (n1, n2) -> ival n1 + ival n2
...
let rec repr = function
  | TwoInts (i1, i2) -> TwoInats (irepr i1, irepr i2)

and irepr = function
  | Zero -> P Z
  | Add1 n -> radd1 (irepr n)
  | Sub1 n -> rsub1 (irepr n)
...
let rec two_esum = function
  | TwoInts (i1, i2) -> [%synt add] (to_int i1) (to_int i2)
